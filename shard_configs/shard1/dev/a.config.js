...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'shard1-signal-dev.panthermediasystem.net',

        // When using authentication, domain for guest users.
        anonymousdomain: 'guest.shard1-signal-dev.panthermediasystem.net',
        ...
        muc: 'conference.shard1-signal-dev.panthermediasystem.net'
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: '//comrex-dev.panthermediasystem.net/http-bind',
    ...
    p2p: {
        ...
        stunServers: [
            { urls: 'stun:shard1-stun-dev.panthermediasystem.net:3478' },
    ...
    deploymentInfo: {
        shard: "shard1",
        //region: '<!--# echo var="http_Region" -->',
        userRegion: '<!--# echo var="http_Region" -->'
    },
