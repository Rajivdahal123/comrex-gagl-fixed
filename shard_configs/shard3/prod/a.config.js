...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'shard3-signal.panthermediasystem.net',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.shard3-signal.panthermediasystem.net',
        ...
        muc: 'conference.shard3-signal.panthermediasystem.net'
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: '//gagl.comrex.com/http-bind',
    ...
    p2p: {
        ...
        stunServers: [
            { urls: 'stun:shard3-stun.panthermediasystem.net:3478' },
