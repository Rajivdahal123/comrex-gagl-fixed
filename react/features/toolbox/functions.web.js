...
export function getToolbarAdditionalButtons(width: number, isMobile: boolean): Set<string> {
    ...
    default: {
        buttons = isMobile
            ? [ 'chat', 'raisehand', 'stats', 'invite', 'overflow', 'connect-codec', 'audio-setting' ]
            : [ 'desktop', 'chat', 'raisehand', 'stats', 'invite', 'overflow', 'connect-codec', 'audio-setting' ];
        break;
    }
    ...
    //     buttons = [ 'chat', 'raisehand', 'stats', 'invite', 'overflow', 'connect-codec', 'audio-setting' ];
    //     break;
    // }
    //
    ...
    //     buttons = [ 'chat', 'raisehand', 'stats', 'invite', 'overflow', 'audio-setting' ];
    //     break;
    // }
    //
    // case width >= WIDTH.FIT_5_ICONS: {
    //     buttons = [ 'chat', 'raisehand', 'stats', 'invite', 'overflow' ];
    //     break;
    // }
    //
