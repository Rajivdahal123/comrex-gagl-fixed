...
import { ActionButton, InputField, PreMeetingLobbyScreen } from '../../../base/premeeting';
...
class LobbyScreen extends AbstractLobbyScreen {
    ...
    render() {
        return (
            <PreMeetingLobbyScreen title = { this.props.t(this._getScreenTitleKey()) }>
                { this._renderContent() }
            </PreMeetingLobbyScreen>
        );
    }
