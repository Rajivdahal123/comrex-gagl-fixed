...
export const SAVE_INVITED_PEOPLE = 'SAVE_INVITED_PEOPLE';
...
export const HIDE_EDIT_PROFILE_DIALOG = 'HIDE_EDIT_PROFILE_DIALOG';

export const BEGIN_EDIT_SECURITY = 'BEGIN_EDIT_SECURITY';

export const HIDE_EDIT_SECURITY_DIALOG = 'HIDE_EDIT_SECURITY_DIALOG';