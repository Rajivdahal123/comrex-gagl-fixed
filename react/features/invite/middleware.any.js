...
import {
    invite,
    removePendingInviteRequests, sendIntoUserList,
...
MiddlewareRegistry.register(store => next => action => {
    ...
    //     dispatch(_saveInvitedPeople(store, action));
    //     break;
    case APP_WILL_MOUNT:
...
// function _saveInvitedPeople(store, action) {
//     const { dispatch } = store;
//     const guestName = action.guestName;
//     const email = action.email;
//
//     dispatch(sendIntoUserList(guestName, email));
// }
