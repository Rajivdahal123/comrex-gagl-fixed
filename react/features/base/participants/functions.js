...
export function getParticipantDisplayName(
    ...
    const codec = jitsiLocalStorage.getItem('codec') ? JSON.parse(jitsiLocalStorage.getItem('codec')) : {};
    ...
    if (participant) {
        if (participant.name) {
            return participant.name === codec?.codec_ip ? codec?.codec_name : participant.name;
        }
