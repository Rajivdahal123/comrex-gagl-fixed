...
class CopyMeetingUrl extends Component<Props, State> {
     ...
     */
    async _copyUrl() {
        const success = await copyText(getDecodedURI(this.props.roomId, this.props.locationURL));
    ...
    render() {
        ...
        const { url, t, roomId, locationURL } = this.props;
            ...
            <div
                ...
                <div
                    ...
                    <div className = 'copy-meeting-text'>
                        { !showCopyLink && !showLinkCopied && getDecodedURI(roomId, locationURL) }
...
function mapStateToProps(state) {
    ...
    const locationURL = state['features/base/connection'].locationURL.href;
