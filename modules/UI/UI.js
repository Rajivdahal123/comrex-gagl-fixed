...
UI.updateUserStatus = (user, status) => {
    ...
    const localUser = jitsiLocalStorage.getItem('features/base/settings') ? JSON.parse(jitsiLocalStorage.getItem('features/base/settings'))?.user : {};
    const codec = reduxState['features/base/settings']?.codec || {};
    ...
    messageHandler.participantNotification(
        displayName === codec?.codec_ip ? codec?.codec_name : displayName,
        '',
        'connected',
